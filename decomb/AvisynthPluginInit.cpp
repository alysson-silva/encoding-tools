...
extern "C" __declspec(dllexport) const char* __stdcall AvisynthPluginInit2(IScriptEnvironment* env)
{
	...
	env->AddFunction("FieldDeinterlace", "c[full]b[threshold]i[dthreshold]i[map]b[blend]b[chroma]b[ovr]s[show]b[debug]b", Create_FieldDeinterlace, 0);
    env->AddFunction("Decimate", "c[cycle]i[mode]i[threshold]f[threshold2]f[quality]i[ovr]s[show]b[debug]b", Create_Decimate, 0);
	env->AddFunction("IsCombed", "c[threshold]i", Create_IsCombed, 0);
	return 0;
}
