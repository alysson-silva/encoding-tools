...
public:
	Decimate::Decimate(PClip _child, int _cycle, int _mode, double _threshold, double _threshold2,
	...
	void __stdcall Decimate::DrawShow(PVideoFrame &src, int useframe, bool forced, int dropframe,
		                              double metric, int inframe, IScriptEnvironment* env);
	void __stdcall Decimate::DrawShowYUY2(PVideoFrame &src, int useframe, bool forced, int dropframe,
		                              double metric, int inframe, IScriptEnvironment* env);
